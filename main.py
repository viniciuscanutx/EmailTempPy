...
class EmailTemp:
    def __init__(self):
        ...
        layout = [
            ...
            [sg.Text('Seu Email Temporário: ', size=(17, 1)), sg.Output(
                size=(40, 1), key='output1'), sg.Button('Copiar!')],
        ...
        self.janela = sg.Window(
            'Temporary Email', layout, icon=f'./img/icon1.ico')
